...
public class gorescue2  extends ControlSystemRescueVan
	...
	public void configure()
		...
		PS_GOAL_GLOBAL[1] = new v_FixedPoint_(1900,1300);//KBAA_ST_3
		PS_GOAL_GLOBAL[2] = new v_FixedPoint_(3700,4100);//krp_hotel
		PS_GOAL_GLOBAL[3] = PS_GOAL_GLOBAL[1];//KBAA_ST_3
		PS_GOAL_GLOBAL[4] = PS_GOAL_GLOBAL[0];//USE

...
public class harrassblue  extends ControlSystemCapture
	...
	public void configure()
		...
		AS_WANDER.weights[4]  = 2.0;
		AS_WANDER.embedded[4] = MS_MOVE_TO_RED_BIN;
		...
		AS_ACQUIRE_BLUE.weights[0]  = 0.7;
		AS_ACQUIRE_BLUE.embedded[0] = MS_AVOID_OBSTACLES;

		AS_ACQUIRE_BLUE.weights[1]  = 1.7;
		AS_ACQUIRE_BLUE.embedded[1] = MS_MOVE_TO_BLUE;

		AS_ACQUIRE_BLUE.weights[2]  = 1.5;
		AS_ACQUIRE_BLUE.embedded[2] = MS_MOVE_TO_RED_BIN;
		...
		AS_DELIVER_BLUE.embedded[5] = MS_AVOID_HOMEBASE;
                ...
                STATE_MACHINE.triggers[WANDER][0]       = PF_BLUE_VISIBLE;
                STATE_MACHINE.follow_on[WANDER][0]      = ACQUIRE_BLUE;
                ...
                STATE_MACHINE.follow_on[ACQUIRE_RED][0] = WANDER;

...
public class v_ResetableFixedPoint_ extends NodeVec2
	{
	/** 
	...
	*/
	public v_ResetableFixedPoint_(double x, double y)
		{
		if (DEBUG) System.out.println("v_FixedPoint_: instantiated");
System.out.println("in v_ResetableFixedPoint_.constructor("+x+","+y+")");
		point = new Vec2(x,y);
		}
	  
  public void setPoint(double x,double y)
    {
      if (DEBUG) System.out.println("in v_ResetableFixedPoint_.setPoint("+x+","+y+")");
System.out.println("in v_ResetableFixedPoint_.setPoint("+x+","+y+")");
      point=new Vec2(x,y);
    }
